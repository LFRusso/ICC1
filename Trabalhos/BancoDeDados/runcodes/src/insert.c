...
*       divididas por um dado delimitador
*/
...
void compute(FILE* regfile, char* input, register_field field){
    ...
    switch(field.type){
        ...
        case 1:
            ...
            fwrite(&int_input, 1, sizeof(int), regfile);
        ...
        case 2:
            ...
            fwrite(&float_input, 1, sizeof(float), regfile);
        ...
        case 3:
            ...
            fwrite(&double_input, 1, sizeof(double), regfile);
